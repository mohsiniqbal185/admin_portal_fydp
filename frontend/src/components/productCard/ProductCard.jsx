...
function ProductCard({project,i}) {

    const navigate = useNavigate()
    const {property_id ,name,location, no_of_tokens, tokens_sold,property_type} = project
  ...
  return (
    <div className='card'>
        ...
        <div className='text-container'>
            ...
            <button onClick={()=>navigate(`/projects/${property_id}`)}><span>Explore</span>&nbsp;<KeyboardArrowRightOutlinedIcon className='icon'/></button>
